...
//        if(session.getAttribute("article")==null) {return 3;}
    ...
    String getComment(@RequestParam int id, @RequestParam int page, @RequestParam int size, HttpSession session) {
        ...
        if (session.getAttribute("user") == null) {
            ...
            return articleService.getCommentList(id, page, size);
